...
# demo_kedro_parameterised_runs documentation build
...
from demo_kedro_parameterised_runs import __version__ as release

# -- Project information -----------------------------------------------------

project = "demo_kedro_parameterised_runs"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "demo_kedro_parameterised_runsdoc"
...
latex_documents = [
    (
        master_doc,
        "demo_kedro_parameterised_runs.tex",
        "demo_kedro_parameterised_runs Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "demo_kedro_parameterised_runs",
        "Project demo_kedro_parameterised_runs codebase.",
        "Data-Science",
    )
]
